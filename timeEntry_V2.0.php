...
<body onload="tableOnLoad();">
	...
	<div style="text-align: left; margin-left: 17%; margin-bottom: 1%;">
		<div style="text-align: left;padding-left: 10px; display: inline-block;">
			<label style="display: block;" for="Date"> W/E Date: </label>
			<input style="margin-top:10px;" type="date" value="<?php echo $date->format('Y-m-d'); ?>" id="Date" name="inDate">
		</div>

		<div style="text-align: left;padding-left: 25px; display: inline-block;">
			<label style="display: block;" for = "empName"> Employee Name: </label>
			<input style="margin-top: 10px;" list="eDropDown" name="employName"/>
				<datalist id="eDropDown"></datalist>
		</div>
		
		<div style="text-align: left;padding-left: 25px; display: inline-block;">
			<label style="display: block;" for="class"> Job Title: </label>
			<input style="margin-top: 10px;" list="cLDropDown" type="text" name="clas" id="clas" />
    ...
    <div style="text-align: left; margin-top: 15px; padding-left: 10px;">
		...
		<label style="display: inline-block;" for="job"> Job Number: </label>
		<label style="display: inline-block; padding-left: 10px;" for="phase">Phase: </label>
		<label style="display: inline-block; padding-left: 105px;" for="costCode"> Cost Code: </label>
		<label style="display: inline-block; padding-left: 60px;" for = "hrType"> HR Type: </label>
		<label style="display: inline-block; padding-left: 7px;" for = "mondayTime"> Mon: </label>
		<label style="display: inline-block; padding-left: 20px;" for = "tuesdayTime"> Tues: </label>
		<label style="display: inline-block; padding-left: 20px;" for = "doubleTime"> Wed: </label>
		<label style="display: inline-block; padding-left: 20px;" for = "doubleTime"> Thurs: </label>
		<label style="display: inline-block; padding-left: 25px;" for = "doubleTime"> Fri: </label>
		<label style="display: inline-block; padding-left: 35px;" for = "doubleTime"> Sat: </label>
		<label style="display: inline-block; padding-left: 30px;" for = "doubleTime"> Sun: </label>
		<label style="display: inline-block; padding-left: 15px;" for = "notes"> Notes: </label>
		</div>
	</div>

    <div style="text-align: left; margin-top: 8px; margin-left: 10px;">
		<div style="text-align: left;padding-left: 10px; display: inline-block;">
			<input style="margin-top:10px; width: 80px;" list="jDropDown" type="text" id="job" name="job"/>
			<input style="margin-top:20px; width: 80px; display: block;" list="jDropDown" type="text" id="job" name="job"/>
			<input style="margin-top:20px; width: 80px; display: block;" list="jDropDown" type="text" id="job" name="job"/>
			<input style="margin-top:20px; width: 80px; display: block;" list="jDropDown" type="text" id="job" name="job"/>
			<input style="margin-top:20px; width: 80px; display: block;" list="jDropDown" type="text" id="job" name="job"/>
			<input style="margin-top:20px; width: 80px; display: block;" list="jDropDown" type="text" id="job" name="job"/>
		...
		<div style="text-align: left;padding-left: 10px; display: inline-block;">
			...
			<input style="margin-top:10px; width: 140px;" list="pDropDown" tabindex="4" type="text" id="phase" name="phase" />
			<input style="margin-top:20px; width: 140px; display: block;" list="pDropDown" type="text" id="phase" name="phase" />
			<input style="margin-top:20px; width: 140px; display: block;" list="pDropDown" type="text" id="phase" name="phase" /> 
			<input style="margin-top:20px; width: 140px; display: block;" list="pDropDown" type="text" id="phase" name="phase" /> 
			<input style="margin-top:20px; width: 140px; display: block;" list="pDropDown" type="text" id="phase" name="phase" /> 
			<input style="margin-top:20px; width: 140px; display: block;" list="pDropDown" type="text" id="phase" name="phase" /> 
		...
		<div style="text-align: left;padding-left: 10px; display: inline-block;">
			...
			<input style="margin-top:10px; width: 140px;" list="cDropDown" type="text" id="costCode" name="costCode">
			<input style="margin-top:20px; width: 140px; display: block;" list="cDropDown" type="text" id="costCode" name="costCode">
			<input style="margin-top:20px; width: 140px; display: block;" list="cDropDown" type="text" id="costCode" name="costCode">
			<input style="margin-top:20px; width: 140px; display: block;" list="cDropDown" type="text" id="costCode" name="costCode">
			<input style="margin-top:20px; width: 140px; display: block;" list="cDropDown" type="text" id="costCode" name="costCode">
			<input style="margin-top:20px; width: 140px; display: block;" list="cDropDown" type="text" id="costCode" name="costCode">
		...
		<div style="text-align: left; padding-left: 10px; display: inline-block;">
			...
			<input style="margin-top:10px; width: 45px;" list="hrType" type="text" id="HRSTyp" name="hrType">
			<input style="margin-top:20px; width: 45px; display: block;" list="hrType" type="text" id="HRSTyp" name="hrType">
			<input style="margin-top:20px; width: 45px; display: block;" list="hrType" type="text" id="HRSTyp" name="hrType">
			<input style="margin-top:20px; width: 45px; display: block;" list="hrType" type="text" id="HRSTyp" name="hrType">
			<input style="margin-top:20px; width: 45px; display: block;" list="hrType" type="text" id="HRSTyp" name="hrType">
			<input style="margin-top:20px; width: 45px; display: block;" list="hrType" type="text" id="HRSTyp" name="hrType">
		...
		<div style="text-align: left; display: inline-block;">
			...
			<input style="margin-top:10px;margin-left: 10px; width: 35px; display: block;" type="number" id="Mon" name="Mon">
			<input style="margin-top:20px;margin-left: 10px; width: 35px; display: block;" type="number" id="Mon" name="Mon">
			<input style="margin-top:20px;margin-left: 10px; width: 35px; display: block;" type="number" id="Mon" name="Mon">
			<input style="margin-top:20px;margin-left: 10px; width: 35px; display: block;" type="number" id="Mon" name="Mon">
			<input style="margin-top:20px;margin-left: 10px; width: 35px; display: block;" type="number" id="Mon" name="Mon">
			<input style="margin-top:20px;margin-left: 10px; width: 35px; display: block;" type="number" id="Mon" name="Mon">
		...
		<div style="text-align: left;padding-left: 20px; display: inline-block;">
			...
			<input style="margin-top:10px; width: 35px;" type="number" id="Tues" name="Tues">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Tues" name="Tues">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Tues" name="Tues">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Tues" name="Tues">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Tues" name="Tues">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Tues" name="Tues">
		...
		<div style="text-align: left;padding-left: 20px; display: inline-block;">
			...
			<input style="margin-top:10px; width: 35px;" type="number" id="Wed" name="Wed">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Wed" name="Wed">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Wed" name="Wed">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Wed" name="Wed">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Wed" name="Wed">
			<input style="margin-top:20px; width: 35px; display: block;" type="number" id="Wed" name="Wed">
		...
		<div style="text-align: left;padding-left: 10px; display: inline-block;">
			...
			<input style="margin-top:10px; width: 140px;" type="text" id="notes" name="notes">
			<input style="margin-top:20px; width: 140px; display: block;" type="text" id="notes" name="notes">
			<input style="margin-top:20px; width: 140px; display: block;" type="text" id="notes" name="notes">
			<input style="margin-top:20px; width: 140px; display: block;" type="text" id="notes" name="notes">
			<input style="margin-top:20px; width: 140px; display: block;" type="text" id="notes" name="notes">
			<input style="margin-top:20px; width: 140px; display: block;" type="text" id="notes" name="notes">
  ...
  <div id="openModal" class="modalDialog">
	<div>
		...
		<div style="text-align: left; padding-left: 10px;">
			<label for = "recnum"> Line Num: </label>
		...
		<div style="text-align: left; padding-left: 10px;">
			<label for = "regTime"> Regular Time: </label>
