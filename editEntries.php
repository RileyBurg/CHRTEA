...
<head>
	...
	border-top: 1px solid #ccc;">
		...
		<h1 style = "margin-top: 5%; text-align: left; margin-left: 8%;">Edit Entries</h1>
</head>
  ...
  <div id="openModal" class="modalDialog">
	<div>
		...
		<div style="text-align: left; padding-left: 10px; display: inline-block;">
			...
			<input style="margin-top:10px; height: auto; width: 65px;" type="text" id="recnum" name="recnum">
		</div>	
		<div style="text-align: left;padding-left: 10px; display: inline-block;">
		...
		<div style="text-align: left;padding-left: 10px; display: inline-block;">
			...
			<input style="margin-top: 10px;" list="eDropDown" name="employName" id="name" />
				<datalist id="eDropDown"></datalist>
		</div>
...
<a href = "http://chrap.chreynolds.com/userMenu.php">
<button type="spaceButton">User Menu</button></a>
...
<script> 
	...
	//adds the results to the actual document
		...
		document.getElementById('hidden_action_form').action = 'editEntrySubmit.php';
...
function editIndex(trValue) 
{
	...
	var formRecnum = document.getElementById('recnum');
	var formDate = document.getElementById('Date');
	var formName = document.getElementById('name');
	var formClass = document.getElementById('clas');
	var formJob = document.getElementById('job');
	var formPhase = document.getElementById('phase');
	var formCost = document.getElementById('costCode');
	var formReg = document.getElementById('RT');
	var formOver = document.getElementById('OT');
	var formDbl = document.getElementById('DT');
	var formNotes = document.getElementById('notes');
